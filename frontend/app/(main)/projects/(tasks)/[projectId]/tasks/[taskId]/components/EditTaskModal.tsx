          ...
          <div className={cx('twoColumn')}>
            <div className={cx('inputContainer')}>
              ...
              <Input
                ...
                type="date"
                defaultValue={
                  new Date(state.startYear!, state.startMonth! - 1, state.startDay!).toISOString().split('T')[0]
                }
              />
            </div>
            <div className={cx('inputContainer')}>
              ...
              <Input
                ...
                name="endDate"
                type="date"
                defaultValue={new Date(state.endYear!, state.endMonth! - 1, state.endDay!).toISOString().split('T')[0]}
              />
            </div>
          </div>
          <div className={cx('inputContainer')}>

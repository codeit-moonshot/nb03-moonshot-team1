...
export const acceptMemberInvitation = async (invitationId: number, token: string): Promise<boolean> => {
  try {
    const response = await axios.post(`/invitations/${invitationId}/accept`, { token });
